<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                {!! Form::select('location_id', \App\Models\Location::where('project_id', $project_id)->pluck('naam', 'id'), NULL, array('class' => 'form-control')) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                {!! Form::select('floor_id', \App\Models\Floor::pluck('naam', 'id'), NULL, array('class' => 'form-control')) !!}
            </div>
        </div>
